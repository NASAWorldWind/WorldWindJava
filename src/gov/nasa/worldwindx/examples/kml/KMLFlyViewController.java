...
public class KMLFlyViewController extends KMLViewController {
     ...
     * final eye altitude as the animation proceeds to ensure that the final view uses the most accurate elevation data.
     *
    ...
    protected class FlyToLookAtAnimator extends FlyToFlyViewAnimator {
         ...
         * @param targetView OrbitView that specifies desired heading, pitch, and zoom. The animator may modify this
         * view as the animation proceeds, and the center position is re-calculated with new elevation data.
