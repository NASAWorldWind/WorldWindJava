...
public class RadarVolume extends AbstractShape {
     ...
     * height entries, the far grid is held in the next width x height entries. This list is retained as-is and is not
     * copied.
     * @param obstructionFlags flags indicating the obstruction state of the specified positions. This array is retained
     * as-is and is not copied. Recognized values are <code>NO_OBSTRUCTION</code> indicating that the specified position
     * is unobstructed, <code>INTERNAL_OBSTRUCTION</code> indicating that the position is obstructed beyond the near
     * grid but before the far grid, <code>EXTERNAL_OBSTRUCTION</code> indicating that the position is obstructed before
     * the near grid.
     ...
     * the inclusion flags array is less than the number of grid positions, the positions list is less than the
     * specified size, or the width or height are less than 2.
     */
