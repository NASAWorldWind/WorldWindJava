...
/**
 * Example of integrating a gazetteer search function using the {@link gov.nasa.worldwind.poi.YahooGazetteer}. The
 * example includes a search dialog box, into which the user can enter a search term or a coordinate pair. When the
