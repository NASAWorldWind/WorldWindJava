...
public class GLTFViewer extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        /**
         * Adds the specified <code>gltfRoot</code> to this app frame's <code>WorldWindow</code> as a new
         * <code>Layer</code>.
         *
...
//        }
    ...
    public static class WorkerThread extends Thread
    {
        ...
        /**
         * Creates a new worker thread from a specified <code>gltfSource</code> and <code>appFrame</code>.
         *
         * @param gltfSource the source of the COLLADA file to load. May be a {@link java.io.File}, a {@link
        ...
        /**
         * Loads this worker thread's COLLADA source into a new <code>{@link gov.nasa.worldwind.ogc.gltf.GLTFRoot}</code>,
         * then adds the new <code>GLTFRoot</code> to this worker thread's <code>AppFrame</code>.
         */
        public void run()
        {
            try
...
//                        appFrame.addGLTFLayer(gltfRoot);
    ...
    public static void main(String[] args)
    {
        ...
        new WorkerThread(new File("testData/gltf/Triangle/glTF-Embedded/Triangle.gltf"),
