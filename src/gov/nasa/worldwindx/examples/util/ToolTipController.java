...
public class ToolTipController implements SelectListener, Disposable {
     ...
     * @param hoverKey the key to use when looking up tool tip text from the shape's AVList when a hover event occurs.
     * May be null, in which case a tool tip is not displayed for hover events.
     */
