...
public class KMLLoading extends ApplicationTemplate {
    ...
    public static class LoaderThread extends Thread {
        ...
        public void run() {
            try {
                Object kmlStream=WWIO.getFileOrResourceAsStream(kmlSource, KMLLoading.class);
                final KMLRoot kmlRoot = KMLRoot.createAndParse(kmlStream);

                // Schedule a task on the EDT to add the parsed document to a layer
                SwingUtilities.invokeLater(() -> {
                    KMLLoading.AppFrame.thisFrame.addKml(kmlRoot);
                });
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame {
        ...
        public AppFrame() {
            ...
            loaderThread = new LoaderThread("testData/KML/LinearRingPlacemark.kml");
        ...
        public void addKml(KMLRoot root) {
            ...
            getWwd().getView().setEyePosition(Position.fromDegrees(32, -112, 10000000));
        }

    }

    public static void main(String[] args) {
        KMLLoading.AppFrame frame = (KMLLoading.AppFrame) ApplicationTemplate.start("KML Loading", AppFrame.class);
        frame.start();
    }
}
