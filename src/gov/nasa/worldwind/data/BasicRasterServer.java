...
//        }
     ...
     * <p>
     * Optional keys are: AVKey.PIXEL_FORMAT (AVKey.ELEVATION | AVKey.IMAGE) AVKey.DATA_TYPE AVKey.BYTE_ORDER
     * (AVKey.BIG_ENDIAN | AVKey.LITTLE_ENDIAN )
     *
     * @return a DataRaster for the requested ROI
     *
     * @throws gov.nasa.worldwind.exception.WWRuntimeException if there is no intersection of the source rasters with
     * the requested ROI or the source format is unknown or not supported by currently loaded drivers
     ...
     * AVKey.SECTOR, and AVKey.IMAGE_FORMAT (mime type) values. Supported mime types are: "image/png", "image/jpeg",
     * "image/dds".
     * <p>
     * Optional keys are: AVKey.PIXEL_FORMAT (AVKey.ELEVATION | AVKey.IMAGE) AVKey.DATA_TYPE AVKey.BYTE_ORDER
     * (AVKey.BIG_ENDIAN | AVKey.LITTLE_ENDIAN )
