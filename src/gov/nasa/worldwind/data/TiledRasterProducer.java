...
public abstract class TiledRasterProducer extends AbstractDataStoreProducer {
    ...
    /**
     * Extracts a maximum level limit from the AVList if the AVList contains
     * AVKey.TILED_RASTER_PRODUCER_LIMIT_MAX_LEVEL. This method requires <code>maxNumOfLevels</code> - the actual
     ...
     * integer number between 0 (for level 0 only) and the actual maximum numbers of levels <code>maxNumOfLevels</code>.
     * <p>
