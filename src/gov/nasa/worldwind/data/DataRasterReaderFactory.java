...
public interface DataRasterReaderFactory {
     ...
     * gov.nasa.worldwind.Configuration}, as specified by the
     * {@link gov.nasa.worldwind.avlist.AVKey#DATA_RASTER_READER_FACTORY_CLASS_NAME}. If no factory is specified in the
     * configuration, {@link gov.nasa.worldwind.data.BasicDataRasterReaderFactory} is used.
     *
