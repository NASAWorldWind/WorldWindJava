...
//            System.out.println(2 * 4 + 4 + this.vertices.length * 3 * 4);
     ...
     *
     * @param globe the terrain's globe.
     * @param sector the desired range for the terrain. Only locations within this sector may be used in operations. If
     * null, the sector spans the entire globe.
     * @param targetResolution the target terrain resolution, in meters, or null to use the globe's highest resolution.
...
//        });
     ...
     * first line in formed by positions[0] and positions[1], the second by positions[2] and positions[3], etc.
     ...
     * @throws InterruptedException if the operation is interrupted. if the current timeout is exceeded while retrieving
     * terrain data.
     */
