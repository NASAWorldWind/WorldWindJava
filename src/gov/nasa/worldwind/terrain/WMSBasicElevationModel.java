...
public class WMSBasicElevationModel extends BasicElevationModel {
     ...
     * <table><caption style="font-weight: bold;">Parameters</caption>
     ...
     * <tr><td>{@link AVKey#DATA_TYPE}</td><td>Translate WMS layer's image format to a matching data
     * type</td><td>String</td></tr> </table> This also parses common WMS layer parameters by invoking {@link DataConfigurationUtils#getWMSLayerConfigParams(gov.nasa.worldwind.ogc.wms.WMSCapabilities,
     * String[], gov.nasa.worldwind.avlist.AVList)}.
     *
     * @param caps the WMS Capabilities source to parse for WMSBasicElevationModel configuration parameters.
     * @param formatOrderPreference an ordered array of preferred image formats, or null to use the default format.
     * @param params the output key-value pairs which recieve the WMSBasicElevationModel configuration parameters.
     *
     ...
     * @throws gov.nasa.worldwind.exception.WWRuntimeException if the Capabilities document does not contain any of the
