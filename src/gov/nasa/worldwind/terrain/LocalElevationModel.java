...
public class LocalElevationModel extends AbstractElevationModel {
     ...
     * @param buffer a buffer in which to return the elevations. Must be at least as large as the list of locations.
     * @param mapMissingData indicates whether to replace any elevations that match this elevation model's missing data
     * signal to this model's missing data replacement value.
     *
     ...
     * in a recognizable format, or if the specified file does not contain required information such as the data's
     * location and data type.
     * @throws IOException if an exception occurs while opening or reading the specified file.
     * @throws WWRuntimeException if an error occurs attempting to read and interpret the elevation data, or if an error
     * occurs attempting to read and interpret the file's contents.
     */
     ...
     * elevation values is considered one row of the array, with the first element of the buffer starting the row of
     * elevations at the sector's maximum latitude.
    ...
    protected static class LocalTile {
         ...
         * @param minEl the minimum elevation of this tile. May be null, in which case the minimum is determined.
         * @param maxEl the maximum elevation of this tile. May be null, in which case the maximum is determined.
         */
