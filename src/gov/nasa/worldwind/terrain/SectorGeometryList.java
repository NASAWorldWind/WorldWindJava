...
public class SectorGeometryList extends ArrayList<SectorGeometry> {
     ...
     *
     * @param line the <code>Line</code> for which an intersection is to be
     * found.
     *
     ...
     * elevation.
     * <p>
     * The returned array of <code>Intersection</code> describes a list of
     * individual segments - two <code>Intersection</code> for each,
     * corresponding to each geometry triangle that intersects the given
     * elevation.
     * <p>
     * Note that the provided bounding <code>Sector</code> only serves as a
     ...
     *
     * @return a list of <code>Intersection</code> pairs/segments describing a
