...
public class BasicLayerFactory extends BasicFactory {
     ...
     * or layer lists are not re-thrown but are logged. The layer or layer list associated with the exception is not
     ...
     * identifying the type of service to use to retrieve layer data. Recognized service types are "Offline",
...
//        System.out.println(name);
     ...
     * location, and may contain elements specifying shapefile attribute mappings, shape attributes to assign to created
