...
public abstract class AbstractLayer extends WWObjectImpl implements Layer {
     ...
     * AVKey#OPACITY}</td><td>Opacity</td><td>Double</td></tr>
     ...
     * @param params the output key-value pairs which recieve the layer configuration parameters. A null reference is
     * permitted.
     *
