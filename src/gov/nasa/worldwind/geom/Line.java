...
//    }
     ...
     *
     * @return The closest point on (p0, p1) to p. Note that this will be p0 or p1 themselves whenever the closest point
     * on the <em>line</em> defined by p0 and p1 is outside the segment (i.e., the results are bounded by the segment
     * endpoints).
     */
     ...
     * the frustum does not fully contain it. If the segment is coincident with a plane of the frustum, the returned
