...
public class Quaternion {
     ...
     * respective unit-axes. The angles are applied in the order X, Y, Z. Angles can be extracted by calling
    ...
    /**
     * Returns a Quaternion created from latitude and longitude rotations. Latitude and longitude can be extracted from
     * a Quaternion by calling {@link #getLatLon}.
     *
