...
public class Sector implements Cacheable, Comparable<Sector>, Iterable<LatLon> {
    ...
    /**
     * A <code>Sector</code> of latitude [-90 degrees, + 90 degrees] and
    ...
    /**
     * Creates a new <code>Sector</code> and initializes it to the specified
    ...
    /**
     * Creates a new <code>Sector</code> and initializes it to angles in the
     ...
     *
     * @throws IllegalArgumentException if <code>array</code> is null or if its
    ...
    /**
     * Creates a new <code>Sector</code> and initializes it to the angles
     ...
     *
     * @throws IllegalArgumentException if <code>zone</code> is outside the
     * range 1-60, if <code>hemisphere</code> is null, or if
     * <code>hemisphere</code> is not one of {@link
    ...
    /**
     * Returns a new <code>Sector</code> encompassing a circle centered at a
     ...
     *
     * @throws IllegalArgumentException if <code>globe</code> or
     * <code>sector</code> is null
     */
     ...
     *
     * @return <code>true</code> if this sector fully contains the input sector,
     ...
     *
     * @return <code>true</code> if the sectors intersect, otherwise
     * <code>false</code>.
     */
     ...
     * @param that the sector to test for intersection.
     *
     * @return <code>true</code> if the sectors' interiors intersect, otherwise
     * <code>false</code>.
     *
     ...
     *
     * @return true <code>true</code> if this sector intersects the line
     ...
     * <code>this</code> if the incoming sector is <code>null</code>.
     */
     ...
     *
     * @return <code>true</code> if the four corresponding angles of each sector
