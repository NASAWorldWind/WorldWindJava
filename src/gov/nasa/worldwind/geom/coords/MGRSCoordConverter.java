...
class MGRSCoordConverter {
     ...
     * coordinates according to the current ellipsoid parameters. If any errors occur, the error code(s) are returned by
     * the function, otherwise UTM_NO_ERROR is returned.
     *
     ...
     * string, according to the current ellipsoid parameters. If any errors occur, the error code(s) are returned by the
     * function, otherwise MGRS_NO_ERROR is returned.
     *
