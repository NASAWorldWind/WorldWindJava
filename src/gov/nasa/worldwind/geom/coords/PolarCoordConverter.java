...
public class PolarCoordConverter {
    ...
    private double Polar_f = 1 / 298.257223563;
    /* Flattening of ellipsoid  */
    private double es = 0.08181919084262188000;
    /* Eccentricity of ellipsoid    */
    private double es_OVER_2 = .040909595421311;
    /* es / 2.0 */
    private double Southern_Hemisphere = 0;
    /* Flag variable */
    ...
    /* Polar_a * mc */
    private double two_Polar_a = 12756274.0;
    /* 2.0 * Polar_a */
 ...
 /* Maximum variance for easting and northing values for WGS 84. */
     ...
     * parameters as inputs, and sets the corresponding state variables. If any errors occur, error code(s) are returned
     * by the function, otherwise POLAR_NO_ERROR is returned.
     *
    ...
    /**
     * The function Convert_Polar_Stereographic_To_Geodetic converts Polar Stereographic coordinates (easting and
     * northing) to geodetic coordinates (latitude and longitude) according to the current ellipsoid and Polar
     * Stereographic projection Parameters. If any errors occur, the code(s) are returned by the function, otherwise
     * POLAR_NO_ERROR is returned.
     *
