...
class TMCoordConverter {
    ...
    /* PI     */
    public final static double PI_OVER = (PI / 2.0);
    /* PI over 2 */
    private final static double MAX_LAT = ((PI * 89.99) / 180.0);
    /* 90 degrees in radians */
    private final static double MAX_DELTA_LONG = ((PI * 90) / 180.0);
    /* 90 degrees in radians */
    ...
    private double TranMerc_f = 1 / 298.257223563;
    /* Flattening of ellipsoid  */
    private double TranMerc_es = 0.0066943799901413800;
 ...
 /* Isometeric to geodetic latitude parameters, default to WGS 84 */
    ...
    public long setTransverseMercatorParameters(double a, double f, double Origin_Latitude,
        ...
        double tn;
        /* True Meridianal distance constant  */
        double tn2;
        double tn3;
        double tn4;
        double tn5;
