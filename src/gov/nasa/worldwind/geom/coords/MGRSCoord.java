...
public class MGRSCoord {
    ...
    /**
     * Create a WGS84 MGRS coordinate from a pair of latitude and longitude <code>Angle</code> with the maximum
     * precision of five digits (one meter).
     *
    ...
    /**
     * Create a WGS84 MGRS coordinate from a pair of latitude and longitude <code>Angle</code> with the given precision
     * or number of digits.
     *
     * @param latitude the latitude <code>Angle</code>.
     * @param longitude the longitude <code>Angle</code>.
    ...
    /**
     * Create a MGRS coordinate from a pair of latitude and longitude <code>Angle</code> with the maximum precision of
     * five digits (one meter).
     *
     * @param latitude the latitude <code>Angle</code>.
     * @param longitude the longitude <code>Angle</code>.
     * @param globe the <code>Globe</code>.
     * @return the corresponding <code>MGRSCoord</code>.
     * @throws IllegalArgumentException if <code>latitude</code> or <code>longitude</code> is null, the
     ...
     * @param globe the <code>Globe</code> - can be null (will use WGS84).
     * @return the corresponding <code>MGRSCoord</code>.
     * @throws IllegalArgumentException if the <code>MGRSString</code> is null or empty, the <code>globe</code> is null,
    ...
    /**
     * Create an arbitrary MGRS coordinate from a pair of latitude-longitude <code>Angle</code> and the corresponding
     * MGRS coordinate string.
     *
     * @param latitude the latitude <code>Angle</code>.
     * @param longitude the longitude <code>Angle</code>.
     * @param MGRSString the corresponding MGRS coordinate string.
     * @throws IllegalArgumentException if <code>latitude</code> or <code>longitude</code> is null, or the MGRSString is
     * null or empty.
     */
