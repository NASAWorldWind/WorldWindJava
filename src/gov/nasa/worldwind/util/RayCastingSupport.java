...
public class RayCastingSupport {
    ...
    /**
     * Compute the intersection <code>Position</code> of the globe terrain with the ray starting at origin in the given
     * direction. Uses default sample length and result precision.
     *
    ...
    /**
     * Compute the intersection <code>Position</code> of the globe terrain with the ray starting at origin in the given
     * direction. Uses the given sample length and result precision.
     *
     * @param globe the globe to intersect with.
     * @param origin origin of the ray.
     * @param direction direction of the ray.
    ...
    /**
     * Compute the intersection <code>Vec4</code> point of the globe terrain with a line segment defined between two
     * points. Uses the default sample length and result precision.
     *
     * @param globe the globe to intersect with.
    ...
    /**
     * Compute the intersection <code>Vec4</code> point of the globe terrain with the a segment defined between two
     * points. Uses the given sample length and result precision.
     *
     * @param globe the globe to intersect with.
     * @param p1 segment start point.
     * @param p2 segment end point.
