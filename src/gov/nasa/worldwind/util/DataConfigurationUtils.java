...
public class DataConfigurationUtils {
     ...
     * <tr><td>Installed
     * DataDescriptor</td><td>./property[@name="dataSet"]/property[@name="gov.nasa.worldwind.avkey.DatasetNameKey"]</td></tr>
     ...
     * <table><caption style="font-weight: bold;">Mapping</caption> <tr><th>Document Type</th><th>Type String</th></tr>
     * <tr><td>Layer Configuration</td><td>"Layer"</td></tr> <tr><td>Elevation Model Configuration</td><td>"Elevation
     * Model"</td></tr> <tr><td>Installed DataDescriptor</td><td>"Layer" or "ElevationModel"</td></tr> <tr><td>WorldWind
     * .NET LayerSet</td><td>"Layer"</td></tr>
     ...
     * @param params the output key-value pairs which receive the DATA_CACHE_NAME parameter. A null reference is
     * permitted.
     *
     ...
     * Path</th><th>Type</th></tr> <tr><td>{@link
     ...
     * ignored. Supported key and parameter names are: <table>
     * <caption style="font-weight: bold;">Mapping</caption><tr><th>Parameter</th><th>Element
     ...
     * @param params the output key-value pairs which receive the WMS layer parameters. A null reference is permitted.
     *
     * @return a reference to params, or a new AVList if params is null.
     *
     * @throws IllegalArgumentException if the document is null.
     ...
     * <caption style="font-weight: bold;">Mapping</caption><tr><th>Key</th><th>Name</th><td>Path</td></tr> <tr><td>{@link
     ...
     * gov.nasa.worldwind.geom.Sector}</td></tr>
     ...
     * gov.nasa.worldwind.geom.LatLon}</td></tr>
     ...
     * Level's expiryTime</td><td>Long</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#FORMAT_SUFFIX}</td><td>FirstLevel's
     * formatSuffix</td><td>String</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#NUM_LEVELS}</td><td>numLevels</td><td>Integer</td></tr>
     ...
     * gov.nasa.worldwind.geom.Sector}</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#SECTOR_RESOLUTION_LIMITS}</td><td>sectorLevelLimits</td>
     ...
     * gov.nasa.worldwind.geom.LatLon}</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#TILE_WIDTH}</td><td>First Level's
     * tileWidth<td><td>Integer</td></tr> <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#TILE_HEIGHT}</td><td>First
     * Level's tileHeight</td><td>Integer</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#LEVEL_ZERO_TILE_DELTA}</td><td>levelZeroTileDelta</td><td>LatLon</td></tr>
     * </table>
     *
     ...
     * constant)<td></td><td>String</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#FORMAT_SUFFIX}</td><td>QuadTileSet/ImageAccessor/ImageFileExtension<td></td><td>String</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#IMAGE_FORMAT}</td><td>QuadTileSet/ImageAccessor/ImageFileExtension
     * (converted to mime type)<td></td><td>String</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#AVAILABLE_IMAGE_FORMATS}</td><td>QuadTileSet/ImageAccessor/ImageFileExtension
     * (converted to mime type)<td></td><td>String array</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#NUM_LEVELS}</td><td>QuadTileSet/ImageAccessor/NumberLevels<td></td><td>Integer</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#NUM_EMPTY_LEVELS}</td><td>0 (integer
     * constant)<td></td><td>Integer</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#SECTOR}</td><td>QuadTileSet/BoundingBox<td></td><td>Sector</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#TILE_ORIGIN}</td><td>(-90, -180) (geographic location
     * constant)<td></td><td>LatLon</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#LEVEL_ZERO_TILE_DELTA}</td><td>QuadTileSet/ImageAccessor/LevelZeroTileSizeDegrees<td></td><td>LatLon</td></tr>
     ...
     * constant)<td></td><td>Boolean</td></tr>
     * <tr><td>{@link gov.nasa.worldwind.avlist.AVKey#TEXTURE_FORMAT}</td><td>"image/dds"<td></td><td>String</td></tr>
     ...
     * @param params the output key-value pairs which receive the LayerSet configuration parameters. A null reference is
     * permitted.
     *
     * @return a reference to params, or a new AVList if params is null.
     *
