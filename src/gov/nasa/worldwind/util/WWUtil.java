...
public class WWUtil {
     ...
     * corresponding component in this color, new colors are generated until one satisfies this requirement, up to the
     ...
     * between 0 and 1, a color equivalent to color1 if <code>amount</code> is 0 or less, or a color equivalent to
     * <code>color2</code> if <code>amount</code> is 1 or more.
     *
     ...
     * null, if <code>hemisphere</code> is not one of {@link gov.nasa.worldwind.avlist.AVKey#NORTH} or
     * {@link gov.nasa.worldwind.avlist.AVKey#SOUTH}, if <code>buffer</code> is null, or if the number of remaining
     ...
     * initialized to 0. The buffer's size limit must be at least as large as that of the specified vertex buffer.
     *
     * @throws IllegalArgumentException if any of the specified buffers are null or the limit of the normal buffer is
     * less than that of the vertex buffer.
     */
