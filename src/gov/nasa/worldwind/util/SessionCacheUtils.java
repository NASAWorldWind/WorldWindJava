...
public class SessionCacheUtils {
    ...
    /**
     * Retrieves the contents of a specified {@link java.net.URL}. If successful, this places the URL contents in a
     ...
     * @param cacheKey the cache key which identifies where the retrieved data is placed in the session cache.
