...
public class BasicQuadTree<T> extends BitSetQuadTreeFilter implements Iterable<T> {
     ...
     * Specifying <code>true</code>, which is the default, may cause an individual item to be associated with multiple
     * quadtree regions if the item's coordinates fall on a region boundary. In this case that item will be returned
     * multiple times from an iterator created by this class. Specifying <code>false</code> prevents this.
     *
     * @throws IllegalArgumentException if <code>numLevels</code> is less than 1.
     */
     ...
     * {@link gov.nasa.worldwind.terrain.SectorGeometry}. This method is a convenience for finding the items
     * intersecting the current visible regions.
     *
