...
public class ImageUtil {
     ...
     *
     * @throws IllegalArgumentException if any of <code>image</code>, <code>canvas</code>, or
     * <code>canvasToImageTransform</code> are null.
     */
     ...
     * <code>imagePoints</code> or <code>geoPoints</code> is null, or if either <code>imagePoints</code> or
     * <code>geoPoints</code> have length less than 3.
     */
     ...
     * @throws IllegalArgumentException if any of <code>sourceImage</code>, <code>destImage</code>,
     * <code>imagePoints</code> or <code>geoPoints</code> is null, or if either <code>imagePoints</code> or
     * <code>geoPoints</code> have length less than 4.
     */
     ...
     * <code>outImagePoints</code> or <code>outGeoPoints</code> is null, or if <code>imagePoints</code> or
     * <code>geoPoints</code> have length less than 4, or if <code>outImagePoints</code> or <code>outGeoPoints</code>
     ...
     * @param aspectRatio the aspect ratio, width/height, of the assembled image. If the aspect ratio is greater than or
     * equal to one, the assembled image uses the full width of the canvas; the height used is proportional to the
     * inverse of the aspect ratio. If the aspect ratio is less than one, the full height of the canvas is used; the
     * width used is proportional to the aspect ratio.
     * <p>
     * The aspect ratio is typically used to maintain consistent width and height units while assembling multiple images
     * into a canvas of a different aspect ratio than the canvas sector, such as drawing a non-square region into a
     * 1024x1024 canvas. An aspect ratio of 1 causes the incoming images to be stretched as necessary in one dimension
     * to match the aspect ratio of the canvas sector.
     * @param image the image to merge into the canvas.
     * @param canvas the canvas into which the images are merged. The canvas is not changed if the specified image and
     * canvas sectors are disjoint.
     *
     ...
     * @param maxLevel the maximum mip level to create. Specifying zero will return an array containing the original
     * image.
     *
     ...
     *
     * @param x horizontal coordinate of the interpolation point relative to the lower left corner of the quadrilateral.
