...
public abstract class BitSetQuadTreeFilter {
     ...
     * at the southwest corner of the parent cell and increment counter-clockwise: cell 1 is SE, cell 2 is NE and cell 3
     * is NW.
     * @param cellRegion an array specifying the coordinates of the cell's region. The first two entries are the minimum
     * and maximum values on the Y axis (typically latitude). The last two entries are the minimum and maximum values on
     * the X axis, (typically longitude).
     * @param itemCoords an array specifying the region or location of the intersecting item. If the array's length is 2
     * it represents a location in [latitude, longitude]. If its length is 4 it represents a region, with the same
     * layout as the <code>nodeRegion</code> argument.
     *
     ...
     *
     * @param level the quadtree level currently being traversed.
     * @param position the position o f the cell in its parent cell, either 0, 1, 2, or 3. Cell positions starts with 0
     * at the southwest corner of the parent cell and increment counter-clockwise: cell 1 is SE, cell 2 is NE and cell 3
     * is NW.
     * @param cellRegion an array specifying the coordinates of the cell's region. The first two entries are the minimum
     * and maximum values on the Y axis (typically latitude). The last two entries are the minimum and maximum values on
     ...
     * represents a location in [latitude, longitude]. If its length is 4 it represents a region, with the same layout
     * as the <code>nodeRegion</code> argument.
     */
    ...
    public static class FindIntersectingBitsOp extends BitSetQuadTreeFilter {
         ...
         * @param outIds a list in which to place the bit positions of intersecting significant cells. May be null, in
         * which case a new list is created. In either case the list is the return value of the method.
         *
         ...
         * maximum latitude, minimum longitude and maximum longitude, in that order. Significant cells that intersect
         * this sector are returned.
         * @param outIds a list in which to place the bit positions of intersecting significant cells. May be null, in
         * which case a new list is created. In either case the list is the return value of the method.
         *
         * @return the bit positions of intersecting significant cells. This is the list specified as the non-null
         ...
         *
         * @param level the quadtree level currently being traversed.
         * @param position the position of the cell in its parent cell, either 0, 1, 2, or 3. Cell positions starts with
         * 0 at the southwest corner of the parent cell and increment counter-clockwise: cell 1 is SE, cell 2 is NE and
         * cell 3 is NW.
         * @param cellRegion an array specifying the coordinates of the cell's region. The first two entries are the
         * minimum and maximum values on the Y axis (typically latitude). The last two entries are the minimum and
         ...
         * is 2 then it represents a location in [latitude, longitude]. If its length is 4 it represents a region, with
