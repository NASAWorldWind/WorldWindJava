...
public class WWMath {
     ...
     * after the specified min and max. Returns a linear interpolation of min and max when the value is between the two.
     * <p>
     * The returned number is undefined if min &gt; max. Otherwise, the returned number is equivalent to the following:
     * <ul> <li>0.0 - If value &lt; min</li> <li>1.0 - If value &gt; max</li> <li>Linear interpolation of min and max -
     * If min &lt;= value &lt;= max</li> </ul>
     *
    ...
    /**
     * Returns a number between 0.0 and 1.0 indicating whether a specified floating point value is before, between or
     * after the specified min and max. Returns a smooth interpolation of min and max when the value is between the two.
     * <p>
     ...
     * <p>
     * The returned number is undefined if min &gt; max. Otherwise, the returned number is equivalent to the following:
     * <ul> <li>0.0 - If value &lt; min</li> <li>1.0 - If value &gt; max</li> <li>Smooth interpolation of min and max -
     * If min &lt;= value &lt;= max</li> </ul>
     *
     * @param value the value to compare to the minimum and maximum.
     * @param min the minimum value.
     ...
     * {@link gov.nasa.worldwind.View}. The returned size is an estimate of the Extent's diameter in window coordinates.
     *
...
//                result = !result;
     ...
     * each plane's positive halfspace is outside the polytope. (Note: This is the opposite convention from that of a
     * view frustum.)
     *
     ...
     * <p>
     * For details the drawing OpenGL primitives, see
     * <a href="http://www.glprogramming.com/red/chapter02.html#name14">http://www.glprogramming.com/red/chapter02.html#name14</a>.
     *
