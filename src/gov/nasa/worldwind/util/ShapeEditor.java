...
public class ShapeEditor implements SelectListener, PropertyChangeListener {
     ...
     * and other affordances. This method must be called when the editor is no longer needed so that the editor may
     * remove the resources it created when it was armed.
     */
...
//            ((Airspace)shadowShape).setHighlightAttributes(shadowAttributes);
     ...
     * location is on the edge indicated by the cross product of a vector normal to the surface at the specified center
     * and a vector from the center to this location.
     ...
     * @param altitude the altitude to use when determining the nearest point. Can be approximate and is not necessarily
     * the altitude of the terrain position.
     * @param locations the list of locations. This list is modified by this method to contain the new location on an
     * edge nearest the specified terrain position.
     *
     ...
     * inserted to the beginning of the list. If the control point ID corresponds to the last location in the list then
     * the new location is appended to the list. Otherwise no operation occurs.
    ...
    /**
     * Updates the control points and affordances for {@link gov.nasa.worldwind.render.airspaces.CappedCylinder} shapes.
     */
    ...
    /**
     * Updates the control points and affordances for {@link gov.nasa.worldwind.render.airspaces.SphereAirspace} shapes.
     */
