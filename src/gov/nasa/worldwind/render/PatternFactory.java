...
public class PatternFactory {
    ...
    /**
     * Draws a pattern using the default scale (.5), bitmap dimensions (32x32) and colors (light grey over a transparent
     * background).
     *
    ...
    /**
     * Draws a pattern with a given <code>Color</code> using the default scale (.5), bitmap dimensions (32x32) and
    ...
    /**
     * Draws a pattern with a given <code>scale</code> using the default bitmap dimensions (32x32) and colors (light
     * grey over a transparent background).
     *
     * @param pattern the pattern to draw. See {@link PatternFactory} static constants.
    ...
    /**
     * Draws a pattern with a given <code>scale</code> and <code>Color</code> using the default bitmap dimensions
     * (32x32) and backgound color (transparent).
     *
     * @param pattern the pattern to draw. See {@link PatternFactory} static constants.
     * @param scale the scale at which the pattern should be drawn (0 to 1).
     * @param lineColor the pattern <code>Color</code>.
    ...
    /**
     * Draws a pattern with a given <code>scale</code> and <code>Color</code>s using the default bitmap dimensions
     * (32x32).
     *
     * @param pattern the pattern to draw. See {@link PatternFactory} static constants.
     * @param scale the scale at which the pattern should be drawn (0 to 1).
    ...
    /**
     * Draws a pattern with a given <code>scale</code>, <code>Color</code> and bitmap dimensions, using the default
     * backgound color (transparent).
     *
     * @param pattern the pattern to draw. See {@link PatternFactory} static constants.
