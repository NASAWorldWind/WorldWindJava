 ...
 * <p>
 * The {@link MultiLineTextRenderer} (MLTR) handles wrapping, measuring and drawing of multiline text strings using
 * Sun's JOGL {@link TextRenderer}. </p>
 * <p>
 * A multiline text string is a character string containing new line characters in between lines. </p>
 * <p>
 * MLTR can handle both regular text with new line separators and a very minimal implementation of HTML. Each type of
 * text has its own methods though. </p>
 * <p>
 * <b>Usage:</b></p>
 * <p>
 * Instantiation:</p>
 * <p>
 * The MLTR needs a Font or a TextRenderer to be instantiated. This will be the font used for text drawing, wrapping and
 * measuring. For HTML methods this font will be considered as the document default font. </p>
 * <pre>
 ...
 * </pre>
 * <p>
 * Wrapping text to fit inside a width and optionally a height</p>
 * <p>
 * The MLTR wrap method will insert new line characters inside the text so that it fits a given width in pixels. </p>
 * <p>
 * If a height dimension above zero is specified too, the text will be truncated if needed, and a continuation string
 * will be appended to the last line. The continuation string can be set with mltr.setContinuationString(); </p>
 * <pre>
 ...
 * </pre>
 * <p>
 * The textBounds rectangle returned contains the width and height of the text as it would be drawn with the current
 * font. </p>
 * <p>
 * Note that textBounds.minX is the number of lines found and textBounds.minY is the maximum line height for the font
 * used. This value can be safely used as the lineHeight argument when drawing - or can even be ommited after a
 * getBounds: draw(text, x, y); ... </p>
 * <p>
 * <b>HTML support</b></p>
 * <p>
 * Supported tags are: <ul>
 * <li>&lt;p&gt;&lt;/p&gt;, &lt;br&gt; &lt;br /&gt;</li> <li>&lt;b&gt;&lt;/b&gt;</li> <li>&lt;i&gt;&lt;/i&gt;</li>
 * <li>&lt;a href="..."&gt;&lt;/a&gt;</li> <li>&lt;font color="#ffffff"&gt;&lt;/font&gt;</li> </ul> ...
 * <p>
 * See {@link AbstractAnnotation}.drawAnnotation() for more usage details. </p>
 *
