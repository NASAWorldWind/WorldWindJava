 ...
 * this object.
 * <p>
 * This class also defines a static <b>default</b> attributes bundle containing default values for all attributes. New
 * <code>AnnotationAttributes</code> refer this static bundle as their default values source when an attribute has not
 * been set. </p>
 * <p>
 * New <code>AnnotationAttributes</code> set have all their attributes pointing to the default values until they are set
 * by the application. Most attributes refer to the default value by using minus one (<code>-1</code>) for numerics and
 * <code>null</code> for objects. </p>
 * <p>
 * The default attributes set can be changed for a non static one under the application control. The process can be
 * extended or cascaded to handle multiple levels of inheritance for default attributes. </p>
 *
...
public class AnnotationAttributes implements Restorable {
     ...
     * shape.
     * <p>
     * Note that <code>AVKey.SHAPE_ELLIPSE</code> draws an ellipse <u>inside</u> the callout bounding rectangle set by
     * its size (see setSize()) or its text bounding rectangle (see setAdjustWidthToText() and setSize() with height set
     * to zero). It is often necessary to have larger Insets dimensions (see setInsets()) to avoid having the text drawn
     * outside the shape border. </p>
     *
     ...
     * <p>
     * If necessary, the text will be wrapped into several lines so as not to exceed the callout preferred
     * <code><b>width</b></code> (minus the <code>Insets</code> <code>left</code> and <code>right</code> dimensions -
     * see {@link #setInsets(java.awt.Insets) setInsets}). However, if
     * {@link #setAdjustWidthToText(String) setAdjustWidthToText} is set to AVKey.SIZE_FIT_TEXT, the final callout width
     * will follow that of the final text bounding rectangle. </p>
     * <p>
     * If necessary, the text will also be truncated so as not to exceed the given <code><b>height</b></code>. A
     * <code>zero</code> value (default) will have the callout follow the final text bounding rectangle height
     * (including the <code>Insets</code> <code>top</code> and <code>bottom</code>). </p> Set to <code>null</code> to
     ...
     *
     * @return the background image as a WWTexture, or null if this AnnotationAttributes has no background image source.
     */
