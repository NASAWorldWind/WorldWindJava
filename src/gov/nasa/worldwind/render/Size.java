...
public class Size {
     ...
     * @param units One of {@link AVKey#PIXELS} or {@link AVKey#FRACTION}. If the {@code units} value is not one of the
     * expected options, {@link AVKey#PIXELS} is used as the default.
