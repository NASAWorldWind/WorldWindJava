...
public class GlobeAnnotation extends AbstractAnnotation implements Locatable, Movable, Draggable {
     ...
     *                     WorldWind#RELATIVE_TO_GROUND}, or {@link WorldWind#ABSOLUTE}. {@code null} indicates that the legacy altitude
     * mode should be used. See {@link #getAltitudeMode()} for details on this mode.
     *
     * @see #getAltitudeMode()
     */
    ...
    protected Double computeLookAtDistance(DrawContext dc) {
        ...
        if (groundPos != null) // Compute distance from eye to the position in the middle of the screen
        {
