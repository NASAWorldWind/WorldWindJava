...
/**
 * An {@link gov.nasa.worldwind.animation.Animator} for elevation values. Calculates a mid-zoom value that gives the
...
public class ViewElevationAnimator extends DoubleAnimator {
     ...
     *                         {@link WorldWind#RELATIVE_TO_GROUND}, or {@link WorldWind#ABSOLUTE}. Altitude mode is not used if {@code globe}
     * is null.
    ...
    /**
     * determines whether this Animator is using midZoom. The mid-point zoom is an interpolated value between
     * minimum(the lesser of beginZoom and endZoom, and maximum zoom (3* the radius of the globe).
     *
     ...
     * and endZoom values is less than the difference between the midZoom value and the larger of the beginZoom or
     * endZoom values.
     *
