...
public interface OrbitView extends View {
    ...
    /**
     * Returns whether the this <code>View</code> will detect collisions with other objects, such as the surface
     * geometry. If true, implementations may also automatically resolve any detected collisions.
     *
    ...
    /**
     * Sets whether or not this <code>View</code> will detect collisions with other objects, such as the surface
     * geometry. If <code>detectCollisions</code> is true, implementations may also automatically resolve any detected
     * collisions.
     *
    ...
    /**
     * Returns whether or not a collision has occurred since the last call to <code>hadCollisions</code>. If
     * {@link #isDetectCollisions} is false, collisions will not be detected and <code>hadCollisions</code> will always
     * return false.
     *
    ...
    /**
     * Get the center position of the OrbitView. The center position is used as the point about which the heading and
     * pitch rotate. It is defined by the intersection of a ray from the eye position through the center of the viewport
     * with the surface of the globe.
     *
    ...
    /**
     * Sets the center position of the OrbitView. The center position is used as the point about which the heading and
     * pitch rotate. It is defined by the intersection of a ray from the eye position through the center of the viewport
     * with the surface of the globe.
     *
    ...
    /**
     * Get the zoom value for the OrbitView. The zoom value is the distance between the eye position and the center
     * position.
     *
    ...
    /**
     * Set the zoom value for the OrbitVeiw. The zoom value is the distance between the eye position and the center
     * position.
     *
