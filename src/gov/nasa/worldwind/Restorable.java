 ...
 * sharing between similar implementations, each implementation of Restorable should design <code>restoreState</code> to
 * accept and ignore unknown structures in state documents. Otherwise, implementations should clearly document how they
 * will behave when encountering an unknown structure.
 * <p>
