...
public class AngleAnimator extends BasicAnimator {
     ...
     * @param propertyAccessor The {@link gov.nasa.worldwind.util.PropertyAccessor} used to modify the data value being
     * animated.
     */
    ...
    /**
     * Set the value being animated via the {@link gov.nasa.worldwind.util.PropertyAccessor} using the passed
     * interpolant. This implementation just does a straight liner interpolation between the {@link #begin} and
     * {@link #end} values.
     *
