...
public class MoveToDoubleAnimator extends DoubleAnimator {
     ...
     * @param smoothing The smoothing factor. A number between 0 and 1. The higher the number the greater the smoothing.
     ...
     *
     * @param end The target value, the value to animate to.
     * @param smoothing smoothing The smoothing factor. A number between 0 and 1. The higher the number the greater the
     * smoothing.
     * @param minEpsilon The minimum difference between the current value and the target value that triggers the end of
     * the animation. Defaults to .001.
