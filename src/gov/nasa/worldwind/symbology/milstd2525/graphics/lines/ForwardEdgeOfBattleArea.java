...
public class ForwardEdgeOfBattleArea extends AbstractMilStd2525TacticalGraphic {
    ...
    protected static class FEBASymbol extends AbstractTacticalSymbol {
         ...
         * aligns with the graphic (which puts the text on the right side of the circle). If the alignment is any value
         * other than AVKey.LEFT or AVKey.RIGHT the alignment is assumed to be AVKey.RIGHT.
         */
