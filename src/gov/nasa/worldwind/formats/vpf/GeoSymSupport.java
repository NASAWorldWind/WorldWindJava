...
public class GeoSymSupport {
     ...
     * <p>
     * Note that the default symbols should only be placed under two conditions: 1. There is no row in the *sym.txt file
     * for the feature (fcode) 2. After evaluating all rows in the *sym.txt file for that fcode, there is no row that
     * results in an evaluation of "true".
     *
