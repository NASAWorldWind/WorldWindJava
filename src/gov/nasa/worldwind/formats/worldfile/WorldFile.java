...
public class WorldFile {
     ...
     * @throws IllegalStateException if the decoded values are not within the normal range of latituded and longitude.
     ...
     * gov.nasa.worldwind.avlist.AVKey#COORDINATE_SYSTEM_PROJECTED} and
     * {@link gov.nasa.worldwind.avlist.AVKey#PROJECTION_NAME} set to
     * {@link gov.nasa.worldwind.avlist.AVKey#PROJECTION_UTM}.
     * {@link gov.nasa.worldwind.avlist.AVKey#PROJECTION_HEMISPHERE} set to either
     * {@link gov.nasa.worldwind.avlist.AVKey#NORTH} or {@link gov.nasa.worldwind.avlist.AVKey#SOUTH}.
     ...
     * gov.nasa.worldwind.avlist.AVKey#COORDINATE_SYSTEM_PROJECTED} and
     * {@link gov.nasa.worldwind.avlist.AVKey#PROJECTION_NAME} set to
     * {@link gov.nasa.worldwind.avlist.AVKey#PROJECTION_UNKNOWN}.</li> <li>Unknown coordinate system - {@link
     * gov.nasa.worldwind.avlist.AVKey#COORDINATE_SYSTEM} set to
     * {@link gov.nasa.worldwind.avlist.AVKey#COORDINATE_SYSTEM_UNKNOWN}.
