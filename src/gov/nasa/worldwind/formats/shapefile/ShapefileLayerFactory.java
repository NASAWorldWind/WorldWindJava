...
public class ShapefileLayerFactory implements Factory, ShapefileRenderable.AttributeDelegate {
    ...
    protected Sector aoiFilter;  // If set, filter shapes by Area of Interest 
    protected boolean useTextureMaps=true;
    ...
    public void setUseTextureMaps(boolean useTextureMaps) {
        this.useTextureMaps=useTextureMaps;
    }

    /**
     * Specifies the area of interest, shapes outside of the AOI are excluded.
     *
     * @param aoiFilter The desired area of interest.
     */
    public void setAOIFilter(Sector aoiFilter) {
...
//        }
    ...
    protected void addRenderablesForMultiPatch(Shapefile shp, RenderableLayer layer) {
        ArrayList<ShapefileMultiPatch> shapes = ShapefileMultiPatch.createMeshes(shp, this.normalShapeAttributes,
                this.highlightShapeAttributes, this, this.aoiFilter, this.useTextureMaps);
        layer.addRenderables(shapes);
//        layer.addRenderable(shapes.get(0));
    }
