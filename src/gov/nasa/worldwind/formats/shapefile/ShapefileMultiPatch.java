...
//            Vec4 p = terrain.getSurfacePoint(l);
//
...
//            int index = vertices.position() / VERTEX_STRIDE; // index of top vertex
//            this.tess.addVertex(l.latitude.degrees, l.longitude.degrees, l.elevation, index); // map lon,lat to x,y
//
...
//            double b = -depth;
//            vertex[0] = (float) (p.x + N.x * t - refPt.x);
//            vertex[1] = (float) (p.y + N.y * t - refPt.y);
//            vertex[2] = (float) (p.z + N.z * t - refPt.z);
//            vertex[3] = (float) (p.x + N.x * b - refPt.x);
//            vertex[4] = (float) (p.y + N.y * b - refPt.y);
//            vertex[5] = (float) (p.z + N.z * b - refPt.z);
////            vertex[0] = (float) (p.x - refPt.x);
////            vertex[1] = (float) (p.y - refPt.y);
////            vertex[2] = (float) (p.z - refPt.z);
//            vertices.put(vertex);
//        }
//
