 ...
 * {@link #readPoints(gov.nasa.worldwind.formats.shapefile.ShapefileRecord,java.nio.ByteBuffer)} to change how the
...
public class Shapefile extends AVListImpl implements Closeable, Exportable {
     ...
     * @throws WWRuntimeException if the shapefile cannot be opened for any reason, or if the shapefile's coordinate
     ...
     * {@link gov.nasa.worldwind.formats.shapefile.ShapefileRecord}. The record's type depends on the Shapefile's type,
     * and is one of the following: <ul> <li>{@link
     ...
     * <li>{@link gov.nasa.worldwind.formats.shapefile.ShapefileRecordMultiPoint} if type is
     * {@link #SHAPE_MULTI_POINT}, {@link #SHAPE_MULTI_POINT_M} or {@link #SHAPE_MULTI_POINT_Z}.</li>
     ...
     * <li>{@link gov.nasa.worldwind.formats.shapefile.ShapefileRecordPolygon} if type is
     * {@link #SHAPE_POLYGON}, {@link #SHAPE_POLYGON_M} or {@link #SHAPE_POLYGON_Z}.</li> </ul>
     * <p>
    ...
    /**
     * Returns a new multi-point {@link gov.nasa.worldwind.formats.shapefile.ShapefileRecord} from the specified buffer.
     * <p>
     * The buffer current position is assumed to be set at the start of the record and will be set to the start of the
     * next record after this method has completed.
     *
...
//                return SHAPE_MULTI_PATCH;
     ...
     * according to the Shapefile's coordinate system. This throws a
     * {@link gov.nasa.worldwind.exception.WWRuntimeException} if the coordinate system is unsupported.
     *
