 ...
 * <code>alphaBlock</code> and <code>colorBlock</code>. The 64 bit alpha block contains 4x4 alpha values quantized into
 * 4 bits. The 64 bit color block is formatted exactly like the DXT1 color block, except that the color block always
 * represents four colors, regardless of the color ordering in the DXT1 block.
 *
 * @author dcollins
