...
public interface Factory {
     ...
     * @throws gov.nasa.worldwind.exception.WWUnrecognizedException if the type of source or some object-specific value
     * is unrecognized.
     * @throws gov.nasa.worldwind.exception.WWRuntimeException if object creation fails. The exception indicating the
     * source of the failure is included as the {@link Exception#initCause(Throwable)}.
     */
