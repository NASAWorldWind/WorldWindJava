...
public class BasicFactory implements Factory {
     ...
     * path available on the classpath. The file contents must be a valid OGC capabilities document.
     * @param params a list of configuration properties. These properties override any specified in the capabilities
     * document. The list should contain the {@link AVKey#LAYER_NAMES} property for services that define layer,
     * indicating which named layers described in the capabilities document to create. If this argumet is null or
     * contains no layers, the first named layer is used.
     *
     ...
     * @throws WWRuntimeException if an error occurs while opening, reading or parsing the capabilities document. The
     * exception indicating the source of the failure is included as the {@link
     ...
     * @param params a list of configuration properties. These properties override any specified in the capabilities
     * document. The list should contain the {@link AVKey#LAYER_NAMES} property for services that define layers,
     * indicating which named layers described in the capabilities document to create. If this argumet is null or
     * contains no layers, the first named layer is used.
     *
     * @return the requested object.
