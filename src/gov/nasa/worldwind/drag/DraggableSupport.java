...
public class DraggableSupport {
     ...
     *                            DraggableSupport#computeRelativePoint(Line, Globe, SceneController, double)} for more information.
     *
    ...
    protected Vec4 computeScreenOffsetFromReferencePosition(Position dragObjectReferencePosition,
        ...
        Vec4 screenPointOffset = new Vec4(
                ...
                dragContext.getInitialPoint().getY() - (dragContext.getView().getViewport().getHeight()
     ...
     * @param globe the globe reference, may be null if the object only implements the {@link Movable} interface.
     */
