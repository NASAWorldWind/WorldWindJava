...
public class KMLMultiGeometry extends KMLAbstractGeometry
{
    ...
    public Sector getExtent()
    {
        ...
        {
            for (KMLAbstractGeometry geometry : this.geometries)
            {
                Sector geometryExtent = geometry.getExtent();
                fullExtent = (fullExtent == null) ? geometryExtent : fullExtent.union(geometryExtent);
            }
        }
        return fullExtent;
    }
