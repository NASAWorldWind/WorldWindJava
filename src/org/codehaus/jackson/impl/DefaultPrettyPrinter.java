...
/**
 * Default {@link PrettyPrinter} implementation that uses 2-space indentation with platform-default linefeeds. Usually
 * this class is not instantiated directly, but instead method {@link JsonGenerator#useDefaultPrettyPrinter} is used,
 * which will use an instance of this class for operation.
 */
public class DefaultPrettyPrinter
    ...
    /**
     * By default, let's use linefeed-adding indenter for separate object entries. We'll further configure indenter to
     * use system-specific linefeeds, and 2 spaces per level (as opposed to, say, single tabs)
     */
    protected Indenter _objectIndenter = new Lf2SpacesIndenter();

    // // // Config, other white space configuration
    /**
     * By default we will add spaces around colons used to separate object fields and values. If disabled, will not use
     * spaces around colon.
     */
    ...
    /**
     * This is a very simple indenter that only every adds a single space for indentation. It is used as the default
