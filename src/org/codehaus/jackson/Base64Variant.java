 ...
 * Although there is somewhat standard basic version (so-called "MIME Base64"), other variants exists, see
 * <a href="http://en.wikipedia.org/wiki/Base64">Base64 Wikipedia entry</a> for details.
 *
...
public final class Base64Variant {
    ...
    /**
     * Marker used to denote ascii characters that do not correspond to a 6-bit value (in this variant), and is not used
     * as a padding character.
     */
    public final static int BASE64_VALUE_INVALID = -1;

    /**
     * Marker used to denote ascii character (in decoding table) that is the padding character using this variant (if
     * any).
     */
     ...
     * to be limited ({@link java.lang.Integer#MAX_VALUE} if not limited).
     * <p>
