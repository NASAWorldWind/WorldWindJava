 ...
 * <p>
 * Note: if application want to explicitly disregard Encoding limitations (to read in JSON encoded using an encoding not
 * listed as allowed), they can use {@link java.io.Reader} /
 * {@link java.io.Writer} instances as input source (or output target).
 */
public enum JsonEncoding {
    ...
    /**
     * Whether encoding is big-endian (if encoding supports such notion). If no such distinction is made (as is the case
     * for {@link #UTF8}), return value is undefined.
     *
     * @return True for big-endian encodings; false for little-endian (or if not applicable)
     */
