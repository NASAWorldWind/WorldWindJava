...
/**
 * Efficient alternative to {@link StringWriter}, based on using segmented internal buffer. Initial input buffer is also
 * recyclable.
 * <p>
 * This class is most useful when serializing JSON content as a String: if so, instance of this class can be given as
 * the writer to <code>JsonGenerator</code>.
 *
 * @since 1.3
 */
