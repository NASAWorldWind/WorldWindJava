...
public abstract class JavaType {
     ...
     * type erasure: type instance may have more information on this). May be an interface or abstract class, so
    ...
    /**
     * More efficient version of {@link #narrowBy}, called by internal framework in cases where compatibility checks are
     * to be skipped.
     *
     * @param subclass Undocumented.
     * @return Undocumented.
    ...
    /**
     * <p>
     * Default implementation is just to call {@link #_narrow}, since underlying type construction is usually identical
     *
     * @param superclass Undocumented.
     * @return Undocumented.
     */
    ...
    /**
     * @return True if type represented is a container type; this includes array, Map and Collection types.
     */
    ...
    /**
     * Method for accessing content type of this type, if type has such a thing: simple types do not, structured types
     * do (like arrays, Collections and Maps)
     *
     * @return Undocumented.
     */
    ...
    /**
     * Method for accessing name of type variable in indicated position. If no name is bound, will use placeholders
     * (derived from 0-based index); if no type variable or argument exists with given index, null is returned.
     *
     * @param index Index of contained type to return
     *
     * @return Contained type at index, or null if no such type exists (no exception thrown)
