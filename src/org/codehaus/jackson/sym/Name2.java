...
/**
 * Specialized implementation of PName: can be used for short Strings that consists of 5 to 8 bytes. Usually this means
 * relatively short ascii-only names.
 * <p>
 * The reason for such specialized classes is mostly space efficiency; and to a lesser degree performance. Both are
 * achieved for short Strings by avoiding another level of indirection (via quad arrays)
 */
