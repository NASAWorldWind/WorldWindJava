 ...
 * <p>
 * Note: that this class extends {@link LinkedHashMap} is an implementation detail -- no code should ever directly call
 * Map methods.
 */
...
public final class InternCache
    ...
    /**
     * Size to use is somewhat arbitrary, so let's choose something that's neither too small (low hit ratio) nor too
