 ...
 * as a "getter" for a logical property, as an alternative to recommended {@link JsonProperty} annotation (which was
...
public @interface JsonGetter {
    ...
    /**
     * Defines name of the logical property this method is used to access ("get"); empty String means that name should
     * be derived from the underlying method (using standard Bean name detection rules)
     *
     * @return Undocumented
     */
